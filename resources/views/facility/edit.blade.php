    ...
    <div class="section banner bg-color-primary container container-palette">
        <div class="container banner-container">
            <div class="banner-body text-center">
                <h2 class="title">Update Facility</h2><!-- ./ banner body -->
            </div>
        </div>
    </div>
    @if (count($errors) > 0)
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card my-4 p-4">
                    ...
                    <form method="POST" action="{{route('room-facility.update',$row->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$row->title}}" name="title" type="text" class="form-control" placeholder="Enter Facility Title" id="title">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
